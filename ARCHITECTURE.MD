...
src/shared-types/   API response types (e.g. OrderQuote), imported as `#shared-types`
```
...
- Repositories return domain types (`WarehouseWithStock`) or `#shared-types` response shapes, so routes never see Prisma models.
